...
function pw_welcome_screen() {
	...
	<div id="pw_welcome_screen">
        ...
        <div class="welcome-box">
	        ...
	        <p class="social-icon clear"><span></span><strong>Social Networking</strong> - Enter your Twitter, Facebook &amp; Flickr usernames so people can find you.</p>
	        <p class="save-icon"><span></span><strong>Save</strong> - Got things looking the way you want? Better make sure to click save.</p>
        </div>
